...
public class TweenControl : MonoBehaviour
{
    ...
    public void PunchPosition(Transform trans, Vector3 target, float duration) // nháy
    {
    ...
    public void MoveFollowBenzier(GameObject go, Vector3 mounthPos, Vector3 endPos, float timeMoveUp = 0.4f, float timeMoveDown = 0.3f, System.Action callback = null) //float timeMoveUp = 2.5f, float timeMoveDown = 1.5f
    {
    ...
    public void MoveFollowBenzierHorizontal(GameObject go, Vector3 mounthPos, Vector3 endPos, float timeMoveUp = 2.5f, float timeMoveDown = 1.5f, System.Action callback = null) //float timeMoveUp = 2.5f, float timeMoveDown = 1.5f
    {
